...
import { DataService, type Event } from '../../../services/dataStore'; // ✅ Fixed path
import WeatherWidget from '../../components/WeatherWidget'; // ✅ Fixed path
  ...
  return (
    ...
    >
      ...
      <View className="px-6 pb-10">
        ...
        {activeEvent?.requiredVendors.map((vendor: string, index: number) => (
          <View
            key={`${vendor}-${index}`}
