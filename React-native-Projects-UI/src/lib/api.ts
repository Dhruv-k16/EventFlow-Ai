...
export const events = {
  ...
  getFunctions: (id: string) =>
    apiFetch<{ parent: Event; functions: Event[] }>(
  ...
  addFunction: (
    ...
    apiFetch<Event>(`/api/events/${id}/sub-events`, {
      method: "POST",
      body: JSON.stringify(data),
    }),
};
...
export const marketplace = {
  search: (params?: {
    ...
    const qs = params
      ...
      : "";
    return publicFetch<{ vendors: Vendor[]; total: number }>(
...
export const vendor = {
  get: (id: string) => apiFetch<Vendor>(`/api/vendor/${id}`),
  ...
  updatePortfolioItem: (
    ...
    apiFetch<PortfolioItem>(`/api/vendor/${id}/portfolio/${portfolioId}`, {
      method: "PATCH",
      body: JSON.stringify(data),
    }),
  ...
  deletePortfolioItem: (id: string, portfolioId: string) =>
    apiFetch<{ success: boolean }>(
      `/api/vendor/${id}/portfolio/${portfolioId}`,
      { method: "DELETE" },
    ),
  ...
  getInventory: (id: string, date?: string) =>
    apiFetch<{
      vendorId: string;
      businessName: string;
      items: (InventoryItem & { availableQty: number; allocatedQty: number })[];
    }>(`/api/vendors/${id}/inventory${date ? "?date=" + date : ""}`),
  ...
  addStaff: (
    id: string,
    data: { name: string; role: string; phone?: string; status?: string },
  ) =>
    apiFetch<any>(`/api/vendor/${id}/staff`, {
      method: "POST",
      body: JSON.stringify(data),
    }),

  updateStaff: (id: string, staffId: string, data: any) =>
    apiFetch<any>(`/api/vendor/${id}/staff/${staffId}`, {
      method: "PATCH",
      body: JSON.stringify(data),
    }),

  deleteStaff: (id: string, staffId: string) =>
    apiFetch<{ success: boolean }>(`/api/vendor/${id}/staff/${staffId}`, {
      method: "DELETE",
    }),
};
...
export const bookings = {
  ...
  get: (id: string) => apiFetch<Booking>(`/api/bookings/${id}`),
...
export const meetings = {
  ...
  schedule: (data: {
    ...
    apiFetch<{ meeting: MeetingRecord; bookingStatus: string }>(
      "/api/meetings",
  ...
  update: (
    ...
    apiFetch<{ meeting: MeetingRecord; bookingAdvancedTo?: string }>(
      `/api/meetings/${id}`,
...
export const plannerStaff = {
  ...
  add: (data: {
    ...
    apiFetch<PlannerStaff>("/api/planner/staff", {
      method: "POST",
      body: JSON.stringify(data),
    }),

  update: (staffId: string, data: Partial<PlannerStaff>) =>
    apiFetch<PlannerStaff>(`/api/planner/staff/${staffId}`, {
      method: "PATCH",
      body: JSON.stringify(data),
    }),

  delete: (staffId: string) =>
    apiFetch<{ success: boolean }>(`/api/planner/staff/${staffId}`, {
      method: "DELETE",
    }),
};
...
export const risk = {
  ...
  getVendor: (id: string) => apiFetch<any>(`/api/risk/vendor/${id}`),
};
...
export const liveEvents = {
  ...
  get: (id: string) => apiFetch<any>(`/api/live-events/${id}`),

  activate: (eventId: string) =>
    apiFetch<any>("/api/live-events", {
      method: "POST",
  ...
  getTasks: (id: string) => apiFetch<any[]>(`/api/live-events/${id}/tasks`),
...
export const staffAssignments = {
  ...
  assign: (
    staffId: string,
    data: { eventId: string; task?: string; notes?: string },
  ) =>
    apiFetch<StaffAssignment>(`/api/planner/staff/${staffId}/assignments`, {
      method: "POST",
      body: JSON.stringify(data),
    }),
